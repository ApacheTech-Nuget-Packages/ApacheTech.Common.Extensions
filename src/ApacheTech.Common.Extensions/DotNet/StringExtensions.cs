...
public static class StringExtensions
{
    ...
    public static bool StartsWithAnyOf(this string @this, IEnumerable<string> subStrings)
        => subStrings.Any(@this.StartsWith);
    ...
    public static bool StartsWithNoneOf(this string @this, IEnumerable<string> subStrings) 
        => !@this.StartsWithAnyOf(subStrings);
    ...
    public static bool ContainsAnyOf(this string @this, IEnumerable<string> subStrings) 
        => subStrings.Any(@this.Contains);
    ...
    public static bool ContainsNoneOf(this string @this, IEnumerable<string> subStrings) 
        => !@this.ContainsAnyOf(subStrings);
    ...
    public static bool EndsWithAnyOf(this string @this, IEnumerable<string> subStrings) 
        => subStrings.Any(@this.EndsWith);
    ...
    public static bool EndsWithNoneOf(this string @this, IEnumerable<string> subStrings) 
        => !@this.EndsWithAnyOf(subStrings);
