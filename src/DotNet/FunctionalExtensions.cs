...
public static class FunctionalExtensions
{
    ...
    /// </remarks>
    public static void InvokeIf<T>(this T @this, Action<T> action, params Func<T, bool>[] tests)
    {
    ...
    public static void InvokeAll<T>(this IEnumerable<T> sequence, Action<T> action)
    {
